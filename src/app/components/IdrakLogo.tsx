export function IdrakLogo({ className = "w-96 h-96" }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* I - blue gradient letter centered on shield */}
      <rect x="13" y="17" width="4" height="22" fill="url(#textGradient)"/>
      
      {/* Dot below shield to make I look like exclamation mark */}
      <circle cx="15" cy="52" r="2.5" fill="url(#textGradient)"/>
      ...
      {/* Arabic text إدراك below DRAK - bigger and repositioned */}
      <text 
        x="74" 
        y="73" 
        fill="url(#textGradient)" 

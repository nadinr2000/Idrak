import { AlertCircle, ArrowLeft, Brain, CheckCircle, Shield, Sparkles, TrendingUp, Wind } from 'lucide-react';
...
export function SensorDetailPanel({ sensor, onBack, generateSensorHistory, emergencyMode }: SensorDetailPanelProps) {
  return (
